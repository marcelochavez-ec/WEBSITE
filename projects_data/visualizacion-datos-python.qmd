...
os.chdir("D:/DATA_SCIENCE_ENDI/NOTEBOOKS_R/MULTIVARIANTE/MARCELO_WEBSITE/")
```
## Estructura de un esquema de gráficos con Matplotlib

::: {.text-center}
<img src="/img/ESTRUCTURA_MATPLOTLIB.png"
     style="height: 50%; width: 100%; object-fit: contain; cursor: pointer;"
     onclick="window.open('https://arxiv.org/abs/2210.07278', '_blank');" />

<img src="/img/DATASET_IPC_INEC.png"
     style="height: 50%; width: 50%; object-fit: contain; cursor: pointer; margin-top: 1em;"
     onclick="window.open('https://arxiv.org/abs/2210.07278', '_blank');" />
:::
...
df_ipc = pd.read_excel("bdd/IPC/SERIE HISTORICA IPC_05_2025.xls",
                        sheet_name="1. ÍNDICE",
                        skiprows=4,
                        engine="xlrd")
...
graficar_inflacion_mensual_plotly(df_inflacion, "FEBRERO")
graficar_inflacion_mensual_plotly(df_inflacion, "MARZO")
graficar_inflacion_mensual_plotly(df_inflacion, "ABRIL")
graficar_inflacion_mensual_plotly(df_inflacion, "MAYO")
```
